...
export const MAGAZINES: Magazine[] = [
  {
    ...
    content: [
      ...
      },
      {
        type: 'tips',
        items: [
          '몸을 따뜻하게 유지하기 — 온찜질이나 따뜻한 샤워는 근육 긴장을 완화하는 데 도움이 될 수 있어요.',
          '가볍게 움직이기 — 오히려 너무 오래 가만히 있으면 몸이 더 굳을 수 있습니다. 짧은 스트레칭이나 가벼운 산책 정도가 좋아요.',
          '미지근한 물 충분히 마시기 — 수분은 연골과 힘줄, 인대 등 관절 조직의 건강을 유지해줘요.',
          '수면 챙기기 — 수면 부족은 통증에 대한 민감도를 올릴 뿐만 아니라 몸의 회복을 방해해요. 매일 7~8시간의 규칙적인 수면을 해봅시다.',
        ],
      },
      { type: 'divider' },
      {
  ...
  {
    id: 'sleep-pain',
    title: '수면 부족이 통증을 더 심하게 만드는 이유',
    subtitle: '잠이 부족하면 통증 역치가 낮아져요',
    tags: [],
    content: [
      {
        type: 'image',
      ...
      },
      {
        type: 'tips',
        items: [
          '❌ 자기 직전 스마트폰 사용 — 블루라이트는 멜라토닌 분비를 늦추고 잠들기 어렵게 만들어요.',
          '❌ 불규칙한 수면 시간 — 자는 시간과 일어나는 시간이 계속 바뀌면 몸의 리듬이 무너지기 쉽습니다.',
          '❌ 늦은 카페인 섭취 — 카페인은 생각보다 몸에 오래 남아요. 취침 최소 8~10시간 전에는 중단하는 것이 좋아요.',
        ],
      },
      { type: 'divider' },
      { type: 'heading', text: '건강한 수면 습관이 통증 완화에 중요해요' },
      {
        type: 'tips',
        items: [
          '같은 시간에 자고 일어나기 — 수면 리듬이 안정되면 몸의 회복도 훨씬 수월해집니다.',
          '자기 전 몸을 편하게 만들기 — 가벼운 스트레칭이나 따뜻한 샤워가 도움이 될 수 있어요.',
          '너무 오래 참지 않기 — 통증 때문에 잠들기 힘들 정도라면 병원 상담이 필요해요.',
        ],
      },
      { type: 'divider' },
      {
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'heading', text: '그래서 이런 통증이 생길 수 있어요' },
      {
        type: 'tips',
        items: [
          '목이 딱딱하게 굳는 느낌 — 무의식적으로 어깨에 힘이 들어가면서 근육이 긴장하기 때문이에요.',
          '이유 없이 머리가 아픈 느낌 — 긴장성 두통은 스트레스와 관련이 깊은 대표적인 증상입니다.',
          '배가 자주 아프거나 속이 불편함 — 스트레스는 소화기관에도 영향을 줄 수 있어요.',
          '자고 일어나도 몸이 무거움 — 몸이 제대로 쉬지 못하고 계속 긴장 상태였기 때문일 수 있습니다.',
        ],
      },
      { type: 'divider' },
